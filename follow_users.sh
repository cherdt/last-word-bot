...
# get users I recently followed
twidge -c $CONFIG lsfollowing > $MYPATH/users_who_follow_me
if [ $? -ne 0 ]
then
...
do
  ...
  echo $USER >> $MYPATH/users_i_follow
    twidge -c $CONFIG follow $USER
    twidge -c $CONFIG dmsend $USER "Thanks for the follow! If you see any lively debate on twitter, loop me in by DMing me a tweet."
